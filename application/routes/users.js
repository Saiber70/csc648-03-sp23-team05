...
//   // Retrieve form data
// const firstname = document.querySelector('#fist_name input').value;
// const lastname = document.querySelector('#last_name input').value;
// const phone = document.querySelector('#phone_number input').value;
// const email = document.querySelector('#sfsu_email input').value;
// const password = document.querySelector('#password input').value;
// const rePassword = document.querySelector('#re_password input').value;


//   // Perform any necessary form validation or data retrieval
...
router.post('/register', (req, res, next) => {
  ...
  // let created = new Date(); // Add the created date
  ...
  db.query("SELECT * FROM SFSU_User WHERE user_name = ? OR user_email = ?", [username, email])
    .then(([results, fields]) => {
      ...
      const usernameExists = results.some(row => row.user_name === username);
      const emailExists = results.some(row => row.user_email === email);
    ...
    .then(([results, fields]) => {
      ...
      console.log("Insertion Fields:", fields);
      if (results && results.affectedRows) {
